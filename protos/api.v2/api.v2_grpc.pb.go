...
const (
	...
	Dgraph_UpdateExtSnapshotStreamingState_FullMethodName = "/api.v2.Dgraph/UpdateExtSnapshotStreamingState"
	Dgraph_StreamExtSnapshot_FullMethodName               = "/api.v2.Dgraph/StreamExtSnapshot"
)
