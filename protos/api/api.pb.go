...
type Operation_DeleteOp int32

const (
	Operation_NONE Operation_DeleteOp = 0
	Operation_ALL  Operation_DeleteOp = 1
	Operation_DATA Operation_DeleteOp = 2
)

var Operation_DeleteOp_name = map[int32]string{
	0: "NONE",
	1: "ALL",
	2: "DATA",
}

var Operation_DeleteOp_value = map[string]int32{
	"NONE": 0,
	"ALL":  1,
	"DATA": 2,
}

func (x Operation_DeleteOp) String() string {
	return proto.EnumName(Operation_DeleteOp_name, int32(x))
}

func (Operation_DeleteOp) EnumDescriptor() ([]byte, []int) {
...
type Operation struct {
	...
	DeleteOp             Operation_DeleteOp `protobuf:"varint,4,opt,name=delete_op,json=deleteOp,proto3,enum=api.Operation_DeleteOp" json:"delete_op,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *Operation) GetDeleteOp() Operation_DeleteOp {
	if m != nil {
		return m.DeleteOp
	}
...
func init() {
	proto.RegisterEnum("api.Operation_DeleteOp", Operation_DeleteOp_name, Operation_DeleteOp_value)
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
func (m *Operation) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DeleteOp != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.DeleteOp))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Operation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeleteOp", wireType)
			}
			m.DeleteOp = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DeleteOp |= Operation_DeleteOp(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
