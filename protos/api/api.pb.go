...
type Mutation struct {
	...
	ForcedSinglePreds []string `protobuf:"bytes,15,rep,name=forced_single_preds,json=forcedSinglePreds,proto3" json:"forced_single_preds,omitempty"`
	// The name of the predicates that should be created as list predicates
	// if they don't exist in the schema.
	ForcedListPreds      []string `protobuf:"bytes,16,rep,name=forced_list_preds,json=forcedListPreds,proto3" json:"forced_list_preds,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Mutation) GetForcedSinglePreds() []string {
	if m != nil {
		return m.ForcedSinglePreds
	}
	return nil
}

func (m *Mutation) GetForcedListPreds() []string {
	if m != nil {
		return m.ForcedListPreds
	}
	return nil
}
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
func (m *Mutation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ForcedListPreds) > 0 {
		for iNdEx := len(m.ForcedListPreds) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ForcedListPreds[iNdEx])
			copy(dAtA[i:], m.ForcedListPreds[iNdEx])
			i = encodeVarintApi(dAtA, i, uint64(len(m.ForcedListPreds[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x82
	...
	if len(m.ForcedSinglePreds) > 0 {
		for iNdEx := len(m.ForcedSinglePreds) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ForcedSinglePreds[iNdEx])
			copy(dAtA[i:], m.ForcedSinglePreds[iNdEx])
			i = encodeVarintApi(dAtA, i, uint64(len(m.ForcedSinglePreds[iNdEx])))
			i--
			dAtA[i] = 0x7a
		}
	}
...
func (m *Mutation) Size() (n int) {
	...
	if len(m.ForcedSinglePreds) > 0 {
		for _, s := range m.ForcedSinglePreds {
			l = len(s)
			n += 1 + l + sovApi(uint64(l))
		}
	}
	if len(m.ForcedListPreds) > 0 {
		for _, s := range m.ForcedListPreds {
			l = len(s)
...
func (m *Mutation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ForcedSinglePreds", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ForcedSinglePreds = append(m.ForcedSinglePreds, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ForcedListPreds", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ForcedListPreds = append(m.ForcedListPreds, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApi(dAtA[iNdEx:])
