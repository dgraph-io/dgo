...
type Value_Vfloat32Val struct {
	Vfloat32Val []byte `protobuf:"bytes,12,opt,name=vfloat32_val,json=vfloat32Val,proto3,oneof" json:"vfloat32_val,omitempty"`
}
type Value_Vfloat64Val struct {
	Vfloat64Val []byte `protobuf:"bytes,13,opt,name=vfloat64_val,json=vfloat64Val,proto3,oneof" json:"vfloat64_val,omitempty"`
}
...
func (*Value_Vfloat64Val) isValue_Val() {}
...
func (m *Value) GetVfloat32Val() []byte {
	if x, ok := m.GetVal().(*Value_Vfloat32Val); ok {
		return x.Vfloat32Val
	}
	return nil
}

func (m *Value) GetVfloat64Val() []byte {
	if x, ok := m.GetVal().(*Value_Vfloat64Val); ok {
		return x.Vfloat64Val
	}
	return nil
}
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
func (m *Value_Vfloat32Val) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Value_Vfloat32Val) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Vfloat32Val != nil {
		i -= len(m.Vfloat32Val)
		copy(dAtA[i:], m.Vfloat32Val)
		i = encodeVarintApi(dAtA, i, uint64(len(m.Vfloat32Val)))
		i--
		dAtA[i] = 0x62
	}
	return len(dAtA) - i, nil
}
func (m *Value_Vfloat64Val) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Value_Vfloat64Val) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Vfloat64Val != nil {
		i -= len(m.Vfloat64Val)
		copy(dAtA[i:], m.Vfloat64Val)
		i = encodeVarintApi(dAtA, i, uint64(len(m.Vfloat64Val)))
		i--
		dAtA[i] = 0x6a
	}
	return len(dAtA) - i, nil
...
func (m *Value_Vfloat32Val) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Value_Vfloat64Val) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Value) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Vfloat32Val", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := make([]byte, postIndex-iNdEx)
			copy(v, dAtA[iNdEx:postIndex])
			m.Val = &Value_Vfloat32Val{v}
			iNdEx = postIndex
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Vfloat64Val", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
