...
type Metrics struct {
	ProcessedUids        map[string]string `protobuf:"bytes,1,rep,name=processed_uids,json=processedUids,proto3" json:"processed_uids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *Metrics) GetProcessedUids() map[string]string {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "api.Metrics.ProcessedUidsEntry")
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	0xa4, 0xcd, 0x9c, 0xb3, 0xbb, 0x96, 0x2c, 0xcf, 0x24, 0xe3, 0x0a, 0x7b, 0xbe, 0xef, 0xec, 0xee,
	...
	,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ProcessedUids == nil {
				m.ProcessedUids = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
