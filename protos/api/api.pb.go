...
type Operation_DropAll struct {
	DropAll bool `protobuf:"varint,2,opt,name=drop_all,json=dropAll,proto3,oneof"`
}
type Operation_DropData struct {
	DropData bool `protobuf:"varint,3,opt,name=drop_data,json=dropData,proto3,oneof"`
}
type Operation_DropAttr struct {
	DropAttr string `protobuf:"bytes,4,opt,name=drop_attr,json=dropAttr,proto3,oneof"`
}
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
