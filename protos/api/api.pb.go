...
type Operation struct {
	...
	// Types that are valid to be assigned to DropScope:
	//	*Operation_DropAttr
	//	*Operation_DropAll
	//	*Operation_DropData
	DropScope            isOperation_DropScope `protobuf_oneof:"drop_scope"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
type isOperation_DropScope interface {
	isOperation_DropScope()
	MarshalTo([]byte) (int, error)
	Size() int
}

type Operation_DropAttr struct {
	DropAttr string `protobuf:"bytes,2,opt,name=drop_attr,json=dropAttr,proto3,oneof"`
}
type Operation_DropAll struct {
	DropAll bool `protobuf:"varint,3,opt,name=drop_all,json=dropAll,proto3,oneof"`
}
type Operation_DropData struct {
	DropData bool `protobuf:"varint,4,opt,name=drop_data,json=dropData,proto3,oneof"`
}

func (*Operation_DropAttr) isOperation_DropScope() {}
func (*Operation_DropAll) isOperation_DropScope()  {}
func (*Operation_DropData) isOperation_DropScope() {}

func (m *Operation) GetDropScope() isOperation_DropScope {
	if m != nil {
		return m.DropScope
	}
	return nil
...
func (m *Operation) GetDropAttr() string {
	if x, ok := m.GetDropScope().(*Operation_DropAttr); ok {
		return x.DropAttr
	}
	return ""
}
...
func (m *Operation) GetDropAll() bool {
	if x, ok := m.GetDropScope().(*Operation_DropAll); ok {
		return x.DropAll
	}
	return false
}

func (m *Operation) GetDropData() bool {
	if x, ok := m.GetDropScope().(*Operation_DropData); ok {
		return x.DropData
	}
	return false
}
...
func (*Operation) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Operation_OneofMarshaler, _Operation_OneofUnmarshaler, _Operation_OneofSizer, []interface{}{
		(*Operation_DropAttr)(nil),
		(*Operation_DropAll)(nil),
		(*Operation_DropData)(nil),
	}
}
...
func _Operation_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Operation)
	// drop_scope
	switch x := m.DropScope.(type) {
	case *Operation_DropAttr:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.DropAttr)
	case *Operation_DropAll:
		t := uint64(0)
		if x.DropAll {
			t = 1
		}
	...
	case nil:
	default:
		return fmt.Errorf("Operation.DropScope has unexpected type %T", x)
	}
	return nil
}
...
func _Operation_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Operation)
	switch tag {
	case 2: // drop_scope.drop_attr
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.DropScope = &Operation_DropAttr{x}
		return true, err
	case 3: // drop_scope.drop_all
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.DropScope = &Operation_DropAll{x != 0}
		return true, err
	case 4: // drop_scope.drop_data
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.DropScope = &Operation_DropData{x != 0}
		return true, err
	default:
		return false, nil
	}
...
func _Operation_OneofSizer(msg proto.Message) (n int) {
	...
	case *Operation_DropAttr:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.DropAttr)))
		n += len(x.DropAttr)
	case *Operation_DropAll:
		n += 1 // tag and wire
		n += 1
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
func (m *Operation) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DropScope != nil {
		nn6, err6 := m.DropScope.MarshalTo(dAtA[i:])
		if err6 != nil {
			return 0, err6
		}
		i += nn6
...
func (m *Operation_DropAttr) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x12
	i++
...
func (m *Operation_DropAll) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x18
	i++
	if m.DropAll {
...
func (m *Operation_DropData) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x20
	i++
	if m.DropData {
...
func (m *TxnContext) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LinRead != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.LinRead.Size()))
		n7, err7 := m.LinRead.MarshalTo(dAtA[i:])
		if err7 != nil {
			return 0, err7
		}
		i += n7
...
func (m *NQuad) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ObjectValue != nil {
		...
		n8, err8 := m.ObjectValue.MarshalTo(dAtA[i:])
		if err8 != nil {
			return 0, err8
		}
		i += n8
...
func (m *Value) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Val != nil {
		nn9, err9 := m.Val.MarshalTo(dAtA[i:])
		if err9 != nil {
			return 0, err9
		}
		i += nn9
...
func (m *Operation_DropAttr) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Operation_DropAll) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Operation_DropData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Operation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.DropScope = &Operation_DropAttr{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
			...
			b := bool(v != 0)
			m.DropScope = &Operation_DropAll{b}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DropData", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			b := bool(v != 0)
			m.DropScope = &Operation_DropData{b}
		default:
			iNdEx = preIndex
			skippy, err := skipApi(dAtA[iNdEx:])
			if err != nil {
